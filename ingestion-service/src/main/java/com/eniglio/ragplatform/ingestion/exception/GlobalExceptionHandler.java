...
public class GlobalExceptionHandler extends GlobalExceptionHandlerSupport {
    ...
    @ExceptionHandler(NotLatestVersionException.class)
    public ResponseEntity<ErrorResponse> handleNotLatestVersion(NotLatestVersionException ex, HttpServletRequest request) {
