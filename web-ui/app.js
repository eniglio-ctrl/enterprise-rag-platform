...
const STRINGS = {
  en: {
    ...
    "auth.departmentsHint": "This tenant already has departments — pick the one(s) you'd like to join. An admin will need to approve before it grants document access.",
    ...
    "documents.columnPages": "Pages",
    "documents.columnChunks": "Chunks",
    "documents.columnActions": "Actions",
    "documents.pagesValue": "{{pages}} page(s)",
    "documents.chunksValue": "{{chunks}} chunk(s)",
    "documents.folderImportButton": "Select a folder",
    "documents.folderImportHint": "Or select a whole folder — every supported file inside it is imported, one at a time; unsupported ones are skipped and listed with a reason.",
    "documents.folderImporting": "Importing folder: {{current}}/{{total}} ({{imported}} imported, {{skipped}} skipped)...",
    "documents.folderImportDone": "Folder import finished: {{imported}} imported, {{skipped}} skipped.",
    "documents.folderSkippedUnsupported": "Unsupported file type — skipped.",
    ...
    "documents.compareButton": "Compare selected",
    "documents.compareCheckboxLabel": "Compare",
    "documents.comparing": "Comparing...",
    "documents.compareFailed": "Could not compare the selected documents.",
    "documents.comparisonTitle": "Comparison",
    "documents.selectAtLeastTwo": "Select at least 2 documents to compare.",
    ...
    "documents.sharedWithUsersLabel": "Users",
    "documents.sharedWithDepartmentsLabel": "Departments",
    ...
    "documents.newVersionButton": "New version",
    "documents.uploadingVersion": "Uploading and indexing version...",
    "documents.newVersionFailed": "Could not upload the new version.",
    "documents.versionLabelCurrent": "v{{version}} (current)",
    "documents.versionLabelOld": "v{{version}}",
    "documents.copyId": "Copy document ID",
    "documents.idCopied": "ID copied.",
    "documents.rowMenuLabel": "More options",
    ...
    "settings.departmentsHeading": "Departments",
    "settings.departmentsHint": "Admin-only: create departments, then assign each teammate to one below. A document can be shared with a whole department instead of picking users one by one.",
    "settings.departmentNamePlaceholder": "Department name (e.g. Finance)",
    "settings.createDepartmentButton": "Create",
    "settings.creatingDepartment": "Creating department...",
    "settings.createDepartmentFailed": "Could not create the department.",
    "settings.noDepartment": "No department",
    "settings.updatingDepartment": "Updating department...",
    "settings.departmentUpdateFailed": "Could not update department.",
    "settings.saveDepartmentButton": "Save",
    "settings.inviteRoleMember": "Member",
    "settings.inviteRoleAdmin": "Admin",
    "settings.pendingRequestsHeading": "Pending department requests",
    "settings.pendingRequestsHint": "Admin-only: approve or reject a teammate's request to join a department. Rejecting removes the request outright — they can ask again later.",
    "settings.pendingRequestsEmpty": "No pending requests.",
    "settings.approveButton": "Approve",
    "settings.rejectButton": "Reject",
    "settings.approvingRequest": "Approving...",
    "settings.rejectingRequest": "Rejecting...",
    "settings.approveRequestFailed": "Could not approve the request.",
    "settings.rejectRequestFailed": "Could not reject the request.",
    "settings.myDepartmentsHeading": "My departments",
    "settings.myDepartmentsHint": "Departments you belong to, and any request still awaiting admin approval. Request to join more below.",
    "settings.pendingBadge": "pending approval",
    "settings.noDepartmentsYet": "Not in any department yet.",
    "settings.requestDepartmentButton": "Request",
    "settings.requestingDepartment": "Requesting...",
    "settings.requestDepartmentFailed": "Could not request the department.",
    "settings.departmentRequested": "Requested — awaiting admin approval.",
    "settings.noDepartmentsToRequest": "You already belong to (or have requested) every department in this tenant.",
    ...
    "conversations.emptyHint": "No conversation yet — start one above. Unlike Knowledge, this one remembers what you already asked, so you can ask follow-up questions naturally.",
  ...
  pt: {
    ...
    "auth.departmentsHint": "Esse tenant já tem departamentos — escolha o(s) que você quer entrar. Um admin precisa aprovar antes de valer para acesso a documentos.",
    ...
    "documents.columnPages": "Páginas",
    "documents.columnChunks": "Trechos",
    "documents.columnActions": "Ações",
    "documents.pagesValue": "{{pages}} página(s)",
    "documents.chunksValue": "{{chunks}} trecho(s)",
    "documents.folderImportButton": "Selecionar uma pasta",
    "documents.folderImportHint": "Ou selecione uma pasta inteira — cada arquivo suportado dentro dela é importado, um de cada vez; os não suportados são pulados e listados com o motivo.",
    "documents.folderImporting": "Importando pasta: {{current}}/{{total}} ({{imported}} importado(s), {{skipped}} pulado(s))...",
    "documents.folderImportDone": "Importação da pasta concluída: {{imported}} importado(s), {{skipped}} pulado(s).",
    "documents.folderSkippedUnsupported": "Tipo de arquivo não suportado — pulado.",
    ...
    "documents.faqTitle": "FAQ",
    "documents.compareButton": "Comparar selecionados",
    "documents.compareCheckboxLabel": "Comparar",
    "documents.comparing": "Comparando...",
    "documents.compareFailed": "Não foi possível comparar os documentos selecionados.",
    "documents.comparisonTitle": "Comparação",
    "documents.selectAtLeastTwo": "Selecione pelo menos 2 documentos para comparar.",
    ...
    "documents.sharedWithUsersLabel": "Usuários",
    "documents.sharedWithDepartmentsLabel": "Departamentos",
    ...
    "documents.newVersionButton": "Nova versão",
    "documents.uploadingVersion": "Enviando e indexando a nova versão...",
    "documents.newVersionFailed": "Não foi possível enviar a nova versão.",
    "documents.versionLabelCurrent": "v{{version}} (atual)",
    "documents.versionLabelOld": "v{{version}}",
    "documents.copyId": "Copiar ID do documento",
    "documents.idCopied": "ID copiado.",
    "documents.rowMenuLabel": "Mais opções",
    ...
    "settings.departmentsHeading": "Departamentos",
    "settings.departmentsHint": "Só para admin: cadastre departamentos e depois atribua cada colega a um deles abaixo. Um documento pode ser compartilhado com um departamento inteiro em vez de escolher usuários um a um.",
    "settings.departmentNamePlaceholder": "Nome do departamento (ex: Financeiro)",
    "settings.createDepartmentButton": "Criar",
    "settings.creatingDepartment": "Criando departamento...",
    "settings.createDepartmentFailed": "Não foi possível criar o departamento.",
    "settings.noDepartment": "Sem departamento",
    "settings.updatingDepartment": "Atualizando departamento...",
    "settings.departmentUpdateFailed": "Não foi possível atualizar o departamento.",
    "settings.saveDepartmentButton": "Salvar",
    "settings.inviteRoleMember": "Membro",
    "settings.inviteRoleAdmin": "Admin",
    "settings.pendingRequestsHeading": "Pedidos de departamento pendentes",
    "settings.pendingRequestsHint": "Só para admin: aprove ou rejeite o pedido de um colega para entrar em um departamento. Rejeitar remove o pedido — ele pode pedir de novo depois.",
    "settings.pendingRequestsEmpty": "Nenhum pedido pendente.",
    "settings.approveButton": "Aprovar",
    "settings.rejectButton": "Rejeitar",
    "settings.approvingRequest": "Aprovando...",
    "settings.rejectingRequest": "Rejeitando...",
    "settings.approveRequestFailed": "Não foi possível aprovar o pedido.",
    "settings.rejectRequestFailed": "Não foi possível rejeitar o pedido.",
    "settings.myDepartmentsHeading": "Meus departamentos",
    "settings.myDepartmentsHint": "Departamentos aos quais você pertence, e qualquer pedido ainda aguardando aprovação do admin. Peça para entrar em mais abaixo.",
    "settings.pendingBadge": "aguardando aprovação",
    "settings.noDepartmentsYet": "Ainda não está em nenhum departamento.",
    "settings.requestDepartmentButton": "Solicitar",
    "settings.requestingDepartment": "Solicitando...",
    "settings.requestDepartmentFailed": "Não foi possível solicitar o departamento.",
    "settings.departmentRequested": "Solicitado — aguardando aprovação do admin.",
    "settings.noDepartmentsToRequest": "Você já está em (ou já pediu) todos os departamentos deste tenant.",
    ...
    "conversations.emptyHint": "Nenhuma conversa ainda — inicie uma acima. Diferente do Conhecimento, esta lembra o que você já perguntou, então dá pra fazer perguntas de acompanhamento naturalmente.",
...
const adminDepartmentsSection = document.getElementById("admin-departments-section");
const adminDepartmentsList = document.getElementById("admin-departments-list");
const adminDepartmentsStatus = document.getElementById("admin-departments-status");
...
const registerDepartments = document.getElementById("register-departments");
const registerDepartmentsList = document.getElementById("register-departments-list");
const registerInvitationInput = document.getElementById("register-invitation");
const adminPendingRequestsSection = document.getElementById("admin-pending-requests-section");
const adminPendingRequestsList = document.getElementById("admin-pending-requests-list");
const adminPendingRequestsStatus = document.getElementById("admin-pending-requests-status");
const myDepartmentsSection = document.getElementById("my-departments-section");
const myDepartmentsChips = document.getElementById("my-departments-chips");
const myDepartmentsPicker = document.getElementById("my-departments-picker");
const requestDepartmentsButton = document.getElementById("request-departments-button");
const myDepartmentsStatus = document.getElementById("my-departments-status");
...
function renderAuthState() {
  ...
  adminDepartmentsSection.hidden = !isAdmin;
  adminPendingRequestsSection.hidden = !isAdmin;
  inviteRoleSelect.hidden = !isAdmin;
  if (isAdmin) {
    loadAdminPanel();
  }

  // docs/adr/0060-multi-department-membership-and-approval.md: "My departments" is
  // for every authenticated member, not just admins - self-service department
  // requests aren't an admin-only capability.
  myDepartmentsSection.hidden = !authenticated;
  if (authenticated) {
    loadMyDepartments();
  }
}
...
function renderKnowledgeStats() {
  ...
  // A full tenant UUID wraps onto two lines in this narrow card - truncated display,
  // full value still available on hover (title) for anyone who actually needs it.
  const tenantId = auth?.tenantId ?? "—";
  statsTenant.textContent = tenantId.length > 12 ? `${tenantId.slice(0, 8)}…` : tenantId;
  statsTenant.title = tenantId;
...
async function loadAdminPanel() {
  try {
    // docs/adr/0059-department-based-sharing.md: a third parallel fetch, same
    // client-side-join pattern users/documents already use - auth-service (owner of
    // departments) never gets called by ingestion-service either.
    // docs/adr/0060-multi-department-membership-and-approval.md: a fourth fetch, the
    // tenant-wide pending-requests queue - same admin-only endpoint shape.
    const [usersResponse, documentsResponse, departmentsResponse, pendingResponse] = await Promise.all([
      fetch(`${AUTH_BASE}/api/v1/auth/users`, { headers: authHeader() }),
      fetch(`${INGESTION_BASE}/api/v1/documents`, { headers: authHeader() }),
      fetch(`${AUTH_BASE}/api/v1/auth/departments`, { headers: authHeader() }),
      fetch(`${AUTH_BASE}/api/v1/auth/department-requests`, { headers: authHeader() }),
    ]);
    if (!usersResponse.ok || !documentsResponse.ok || !departmentsResponse.ok || !pendingResponse.ok) {
    ...
    renderKnowledgeStats();
    renderAdminDepartments(departments);
    renderPendingRequests(pendingRequests);
    renderAdminUsers(users, departments);
    ...
    renderAdminDocuments(documents, users, departments);
  } catch (error) {
...
/**
 * docs/adr/0060-multi-department-membership-and-approval.md: the admin's tenant-wide
 * approval queue - "fulano pediu Financeiro, há 2 dias" with Approve/Reject per row.
 * Approve/reject both just reload the whole admin panel afterward, same
 * "refetch everything" pattern every other save handler here already uses.
 */
function renderPendingRequests(requests) {
  adminPendingRequestsList.innerHTML = "";
  if (requests.length === 0) {
    const empty = document.createElement("li");
    empty.innerHTML = `<span class="meta">${t("settings.pendingRequestsEmpty")}</span>`;
    adminPendingRequestsList.appendChild(empty);
    return;
  }
  requests.forEach((request) => {
    const item = document.createElement("li");
    item.innerHTML = `
      <span class="source">${escapeHtml(request.userEmail)}</span>
      <span class="meta">${escapeHtml(request.departmentName)}</span>
      <button type="button" class="pending-approve" data-user-id="${escapeHtml(request.userId)}" data-department-id="${escapeHtml(request.departmentId)}">${t("settings.approveButton")}</button>
      <button type="button" class="pending-reject" data-user-id="${escapeHtml(request.userId)}" data-department-id="${escapeHtml(request.departmentId)}">${t("settings.rejectButton")}</button>
    `;
    adminPendingRequestsList.appendChild(item);
  });

  adminPendingRequestsList.querySelectorAll(".pending-approve").forEach((button) => {
    button.addEventListener("click", async () => {
      setStatus(adminPendingRequestsStatus, t("settings.approvingRequest"));
      try {
        const response = await fetch(
          `${AUTH_BASE}/api/v1/auth/users/${button.dataset.userId}/department-requests/${button.dataset.departmentId}/approve`,
          { method: "POST", headers: authHeader() },
        );
        if (!response.ok) {
          const body = await response.json();
          throw new Error(body.message ?? t("settings.approveRequestFailed"));
        }
        setStatus(adminPendingRequestsStatus, "", "");
        loadAdminPanel();
      } catch (error) {
        setStatus(adminPendingRequestsStatus, error.message ?? t("settings.approveRequestFailed"), "error");
      }
    });
  });

  adminPendingRequestsList.querySelectorAll(".pending-reject").forEach((button) => {
    button.addEventListener("click", async () => {
      setStatus(adminPendingRequestsStatus, t("settings.rejectingRequest"));
      try {
        const response = await fetch(
          `${AUTH_BASE}/api/v1/auth/users/${button.dataset.userId}/department-requests/${button.dataset.departmentId}`,
          { method: "DELETE", headers: authHeader() },
        );
        if (!response.ok && response.status !== 204) {
          const body = await response.json();
          throw new Error(body.message ?? t("settings.rejectRequestFailed"));
        }
        setStatus(adminPendingRequestsStatus, "", "");
        loadAdminPanel();
      } catch (error) {
        setStatus(adminPendingRequestsStatus, error.message ?? t("settings.rejectRequestFailed"), "error");
      }
    });
  });
}
...
/**
 * docs/adr/0059-department-based-sharing.md: the "cadastrar os departamentos"
 * half of the feature - admin-only, create + list, no rename/delete. Reloads the
 * whole admin panel after creating one, same "just refetch everything" pattern the
 * role/sharing/versioning save handlers already use.
 */
function renderAdminDepartments(departments) {
  // Compact chips, not one full-width row per department - a plain list of names
  // doesn't need the same "Documento / Páginas / Trechos" column shape the rest of
  // .history is built for, and wastes horizontal space at this length.
  adminDepartmentsList.innerHTML = departments
    .map((department) => `<span class="department-chip department-chip-neutral">${escapeHtml(department.name)}</span>`)
    .join("");
}
...
createDepartmentForm.addEventListener("submit", async (event) => {
  ...
  setStatus(adminDepartmentsStatus, t("settings.creatingDepartment"));
  try {
    const response = await fetch(`${AUTH_BASE}/api/v1/auth/departments`, {
      method: "POST",
    ...
    const body = await response.json();
    if (!response.ok) {
      throw new Error(body.message ?? t("settings.createDepartmentFailed"));
    }
    setStatus(adminDepartmentsStatus, "", "");
    createDepartmentForm.reset();
    loadAdminPanel();
  } catch (error) {
    setStatus(adminDepartmentsStatus, error.message ?? t("settings.createDepartmentFailed"), "error");
  }
});

/**
 * docs/adr/0060-multi-department-membership-and-approval.md: a user can belong to
 * several departments now, so the old single `<select>` becomes a checkbox group -
 * one Save button per row still, but it PATCHes the whole approved set at once via
 * `/departments`, same "replace the whole list" shape the Documents sharing checklist
 * already uses for `sharedDepartments`.
 */
function renderAdminUsers(users, departments) {
  const auth = getAuth();
  ...
  users.forEach((user) => {
    ...
    const approved = user.approvedDepartments ?? [];
    const pending = user.pendingDepartments ?? [];
    const departmentCheckboxes = departments
      .map((department) => {
        const checked = approved.includes(department.name) ? "checked" : "";
        const isPending = pending.includes(department.name);
        return `
          <label class="admin-department-option">
            <input type="checkbox" class="admin-department-checkbox" value="${escapeHtml(department.name)}" ${checked} />
            ${escapeHtml(department.name)}${isPending ? ` <span class="badge-pending">${t("settings.pendingBadge")}</span>` : ""}
          </label>
        `;
      })
      .join("");
    item.innerHTML = `
      ...
      <div class="admin-department-checkboxes">${departmentCheckboxes || `<span class="meta">${t("settings.noDepartment")}</span>`}</div>
      <button type="button" class="admin-save-department" data-user-id="${escapeHtml(user.id)}">${t("settings.saveDepartmentButton")}</button>
  ...
  adminUsersList.querySelectorAll("button[data-user-id][data-next-role]").forEach((button) => {
    button.addEventListener("click", async () => {
  ...
  adminUsersList.querySelectorAll(".admin-save-department").forEach((button) => {
    button.addEventListener("click", async () => {
      const checkboxes = button.parentElement.querySelectorAll(".admin-department-checkbox:checked");
      const selectedDepartments = Array.from(checkboxes).map((checkbox) => checkbox.value);
      setStatus(adminUsersStatus, t("settings.updatingDepartment"));
      try {
        const response = await fetch(
          `${AUTH_BASE}/api/v1/auth/users/${button.dataset.userId}/departments`,
          {
            method: "PATCH",
            headers: { "Content-Type": "application/json", ...authHeader() },
        ...
        const body = await response.json();
        if (!response.ok) {
          throw new Error(body.message ?? t("settings.departmentUpdateFailed"));
        }
        setStatus(adminUsersStatus, t("documents.saved"), "success");
        loadAdminPanel();
      } catch (error) {
        setStatus(adminUsersStatus, error.message ?? t("settings.departmentUpdateFailed"), "error");
      }
    });
  });
}
...
/**
 * docs/adr/0060-multi-department-membership-and-approval.md: self-service, for every
 * authenticated member (not just admins) - shows the caller's own approved/pending
 * departments plus a picker for departments not yet requested or approved. Fetches
 * `/users/me` (own state) and `/departments` (now open to any member) in parallel.
 */
async function loadMyDepartments() {
  try {
    const [profileResponse, departmentsResponse] = await Promise.all([
      fetch(`${AUTH_BASE}/api/v1/auth/users/me`, { headers: authHeader() }),
      fetch(`${AUTH_BASE}/api/v1/auth/departments`, { headers: authHeader() }),
    ]);
    if (!profileResponse.ok || !departmentsResponse.ok) {
      return;
    }
    const profile = await profileResponse.json();
    const departments = await departmentsResponse.json();
    renderMyDepartments(profile, departments);
  } catch {
    // Non-critical - the rest of the app still works if this one card fails to load.
  }
}

function renderMyDepartments(profile, departments) {
  const approved = profile.approvedDepartments ?? [];
  const pending = profile.pendingDepartments ?? [];

  myDepartmentsChips.innerHTML = "";
  if (approved.length === 0 && pending.length === 0) {
    myDepartmentsChips.innerHTML = `<span class="meta">${t("settings.noDepartmentsYet")}</span>`;
  } else {
    approved.forEach((name) => {
      const chip = document.createElement("span");
      chip.className = "department-chip department-chip-approved";
      chip.textContent = name;
      myDepartmentsChips.appendChild(chip);
    });
    pending.forEach((name) => {
      const chip = document.createElement("span");
      chip.className = "department-chip department-chip-pending";
      chip.textContent = `${name} (${t("settings.pendingBadge")})`;
      myDepartmentsChips.appendChild(chip);
    });
  }

  const requestable = departments.filter(
    (department) => !approved.includes(department.name) && !pending.includes(department.name),
  );
  if (requestable.length === 0) {
    myDepartmentsPicker.innerHTML = `<span class="meta">${t("settings.noDepartmentsToRequest")}</span>`;
    requestDepartmentsButton.hidden = true;
  } else {
    myDepartmentsPicker.innerHTML = requestable
      .map((department) => `
        <label class="admin-department-option">
          <input type="checkbox" class="my-department-checkbox" value="${escapeHtml(department.name)}" />
          ${escapeHtml(department.name)}
        </label>
      `)
      .join("");
    requestDepartmentsButton.hidden = false;
  }
}

requestDepartmentsButton.addEventListener("click", async () => {
  const selected = Array.from(myDepartmentsPicker.querySelectorAll(".my-department-checkbox:checked"))
    .map((checkbox) => checkbox.value);
  if (selected.length === 0) {
    return;
  }
  setStatus(myDepartmentsStatus, t("settings.requestingDepartment"));
  try {
    const response = await fetch(`${AUTH_BASE}/api/v1/auth/users/me/department-requests`, {
      method: "POST",
      headers: { "Content-Type": "application/json", ...authHeader() },
    ...
    const body = await response.json();
    if (!response.ok) {
      throw new Error(body.message ?? t("settings.requestDepartmentFailed"));
    }
    setStatus(myDepartmentsStatus, t("settings.departmentRequested"), "success");
    loadMyDepartments();
  } catch (error) {
    setStatus(myDepartmentsStatus, error.message ?? t("settings.requestDepartmentFailed"), "error");
  }
});

/** A small file-glyph shown before a document's name in every document list row. */
function docIconSvg() {
  return `<svg class="doc-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5z"/><path d="M14 2v6h6"/></svg>`;
}

/**
 * The "⋮" affordance visible on every document row (session history and the admin
 * list) - today it only offers copying the documentId, but it's a real, reusable
 * per-row menu rather than a decorative button, so a second action (e.g. delete) has
 * somewhere to go later without another redesign.
 */
function rowMenuHtml() {
  return `
    <div class="row-menu">
      <button type="button" class="icon-button row-menu-button" data-i18n-title="documents.rowMenuLabel">
        <svg viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="5" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="12" cy="19" r="1.6"/></svg>
      </button>
      <div class="row-menu-dropdown" hidden>
        <button type="button" class="row-menu-copy-id">${t("documents.copyId")}</button>
      </div>
    </div>
  `;
}

/** Wires the open/close/click-outside behavior and the copy-id action for {@link rowMenuHtml}. */
function wireRowMenu(item, documentId, statusEl) {
  const menuButton = item.querySelector(".row-menu-button");
  const dropdown = item.querySelector(".row-menu-dropdown");
  ...
  item.querySelector(".row-menu-copy-id").addEventListener("click", async (event) => {
    event.stopPropagation();
    dropdown.hidden = true;
    await navigator.clipboard.writeText(documentId);
    if (statusEl) {
      setStatus(statusEl, t("documents.idCopied"), "success");
    }
  });
}

/**
 * docs/adr/0058-document-versioning.md: groups by `documentGroupId` (falling back to
 * the document's own id, matching the ingestion side's "own group by default"
 * convention) and sorts each group by `version` ascending, so every version of the
 * same logical document renders together and in order - no separate grouped
 * component, just an ordering choice over the same flat list.
 */
function sortedByVersionGroup(documents) {
  return [...documents].sort((a, b) => {
    const groupCompare = (a.documentGroupId ?? a.documentId).localeCompare(b.documentGroupId ?? b.documentId);
    return groupCompare !== 0 ? groupCompare : a.version - b.version;
  });
}

function renderAdminDocuments(documents, users, departments) {
  const emailById = new Map(users.map((user) => [user.id, user.email]));
  adminDocumentsList.innerHTML = "";
  sortedByVersionGroup(documents).forEach((doc) => {
    const item = document.createElement("li");
    const ownerEmail = emailById.get(doc.ownerId) ?? doc.ownerId;
    const versionLabel = t(
      doc.isLatestVersion ? "documents.versionLabelCurrent" : "documents.versionLabelOld",
      { version: doc.version },
    );
    const checkboxes = users
      ...
      `)
      .join("");
    // docs/adr/0059-department-based-sharing.md: a second, independent checklist next
    // to the per-user one above - a document can be shared with specific users AND
    // whole departments at once, so both render together, not as a toggle between them.
    const departmentCheckboxes = departments
      .map((department) => `
        <label>
          <input type="checkbox" class="department-checkbox" value="${escapeHtml(department.name)}" ${
            (doc.sharedDepartments ?? []).includes(department.name) ? "checked" : ""
          } />
          ${escapeHtml(department.name)}
        </label>
      `)
    ...
    item.innerHTML = `
      <div>
        <span class="source">${docIconSvg()}${escapeHtml(doc.source)}</span>
      ...
      <div class="admin-document-controls">
        <div class="admin-controls-left">
          ...
          <label class="compare-checkbox-label">
            <input type="checkbox" class="compare-checkbox" value="${escapeHtml(doc.documentId)}" />
            ${t("documents.compareCheckboxLabel")}
          </label>
          ${doc.isLatestVersion ? `
            <button type="button" class="new-version-button">${t("documents.newVersionButton")}</button>
            <input type="file" class="new-version-input" hidden />
          ` : ""}
        </div>
      ...
      <div class="admin-shared-with" ${doc.visibility === "RESTRICTED" ? "" : "hidden"}>
        <div class="admin-shared-with-group">
          <span class="admin-shared-with-group-label">${t("documents.sharedWithUsersLabel")}</span>
          ${checkboxes}
        </div>
        <div class="admin-shared-with-group">
          <span class="admin-shared-with-group-label">${t("documents.sharedWithDepartmentsLabel")}</span>
    ...
    wireNewVersionButton(item, doc.documentId, docStatus);
    wireRowMenu(item, doc.documentId, docStatus);

    item.querySelector(".admin-save-sharing").addEventListener("click", async () => {
      const visibility = select.value;
      const sharedWith = Array.from(sharedWithDiv.querySelectorAll("input:checked:not(.department-checkbox)"))
        .map((input) => input.value);
      const sharedDepartments = Array.from(sharedWithDiv.querySelectorAll("input.department-checkbox:checked"))
        .map((input) => input.value);
      ...
      try {
        const response = await fetch(`${INGESTION_BASE}/api/v1/documents/${doc.documentId}/sharing`, {
          method: "PATCH",
          headers: { "Content-Type": "application/json", ...authHeader() },
          body: JSON.stringify({ visibility, sharedWith, sharedDepartments }),
        });
        const body = await response.json();
        if (!response.ok) {
...
/**
 * docs/adr/0058-document-versioning.md: only rendered for a document's latest
 * version (see the `doc.isLatestVersion` guard in the template above) - superseding
 * an already-superseded version is rejected server-side (409) anyway, so the button
 * simply isn't offered for one. Reuses the exact same multipart POST as the main
 * upload form, only adding `supersedes` as a query parameter.
 */
function wireNewVersionButton(item, documentId, statusEl) {
  const button = item.querySelector(".new-version-button");
  if (!button) {
    return;
  }
  const fileInput = item.querySelector(".new-version-input");
  ...
  fileInput.addEventListener("change", async () => {
    ...
    setStatus(statusEl, t("documents.uploadingVersion"));
    const formData = new FormData();
    formData.append("file", file);
    try {
      const response = await fetch(`${INGESTION_BASE}/api/v1/documents?supersedes=${encodeURIComponent(documentId)}`, {
        method: "POST",
        headers: authHeader(),
        body: formData,
      });
      const body = await response.json();
      if (!response.ok) {
        throw new Error(body.message ?? t("documents.newVersionFailed"));
      }
      setStatus(statusEl, t("documents.saved"), "success");
      loadAdminPanel();
    } catch (error) {
      setStatus(statusEl, error.message ?? t("documents.newVersionFailed"), "error");
    } finally {
      fileInput.value = "";
    }
  });
...
// docs/adr/0060-multi-department-membership-and-approval.md: fetches the tenant's
// department list scoped to this exact invitation token (unauthenticated - the
// invitee has no account yet) and renders a checkbox per department, only once the
// token field actually has something in it. Silently hides/clears on a blank or
// invalid token rather than surfacing an error on every keystroke - the real error
// (if the token turns out to be bad) shows up on submit instead.
async function refreshRegisterDepartments() {
  const token = registerInvitationInput.value.trim();
  if (!token) {
    registerDepartments.hidden = true;
    registerDepartmentsList.innerHTML = "";
    return;
  }
  try {
    const response = await fetch(`${AUTH_BASE}/api/v1/auth/invitations/${encodeURIComponent(token)}/departments`);
    if (!response.ok) {
      registerDepartments.hidden = true;
      registerDepartmentsList.innerHTML = "";
      return;
    ...
    registerDepartmentsList.innerHTML = departments
      .map((department) => `
        <label class="admin-department-option">
          <input type="checkbox" class="register-department-checkbox" value="${escapeHtml(department.name)}" />
          ${escapeHtml(department.name)}
        </label>
      `)
      .join("");
    registerDepartments.hidden = false;
  } catch {
    registerDepartments.hidden = true;
    registerDepartmentsList.innerHTML = "";
  }
}
registerInvitationInput.addEventListener("input", refreshRegisterDepartments);
...
registerForm.addEventListener("submit", async (event) => {
  ...
  const requestedDepartments = Array.from(
    registerDepartmentsList.querySelectorAll(".register-department-checkbox:checked"),
  ).map((checkbox) => checkbox.value);
  ...
  try {
    const response = await fetch(`${AUTH_BASE}/api/v1/auth/register`, {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email, password, invitationToken, requestedDepartments }),
    });
    const body = await response.json();
    if (!response.ok) {
...
inviteForm.addEventListener("submit", async (event) => {
  ...
  // docs/adr/0060-multi-department-membership-and-approval.md: the role select is
  // hidden (and its value irrelevant) for a non-admin caller - the backend enforces
  // the same "only an admin may request ADMIN" rule regardless, this just avoids
  // showing a control that would 403 for most callers.
  const role = inviteRoleSelect.hidden ? "MEMBER" : inviteRoleSelect.value;
...
const uploadHistoryHeader = document.getElementById("upload-history-header");
...
const insightComparison = document.getElementById("insight-comparison");
const insightFaqList = document.getElementById("insight-faq-list");

const compareHistoryButton = document.getElementById("compare-history-button");
const compareHistoryStatus = document.getElementById("compare-history-status");
const compareAdminButton = document.getElementById("compare-admin-button");
const compareAdminStatus = document.getElementById("compare-admin-status");
...
const conversationEmptyHint = document.getElementById("conversation-empty-hint");
...
// Found for real writing the Cypress E2E suite: overwriting className wholesale
// wiped out any extra class an element had beyond "status" (e.g. admin-doc-status,
// insight-status) the moment its first status message was shown. Invisible to a
// user (no CSS keys off those extra classes, and the click handlers already hold
// a direct JS reference to the element, not a fresh selector), but it broke any
// code - a test, or a future feature - that re-selects the element by that class
// afterward. classList.add/remove only ever touches the two "kind" modifiers,
// leaving every other class on the element alone.
...
/**
 * docs/EXTERNAL-DATA-INTEGRATION-ROADMAP.md Phase 2: the one
 * POST /api/v1/documents call, shared by the single-file dropzone submit below
 * and the folder-import loop further down - both need the exact same
 * fetch/response handling, just different orchestration around it (the single-file
 * form aborts on any error; the folder loop keeps going to the next file). Returns
 * `null` on a 401 (clearAuth already ran, nothing left for a caller to do but stop),
 * throws on any other non-2xx response, returns the parsed body on success.
 */
...
const ACCEPTED_EXTENSIONS = fileInput.accept.split(",").map((ext) => ext.trim().toLowerCase());
...
/**
 * docs/EXTERNAL-DATA-INTEGRATION-ROADMAP.md Phase 2: `webkitdirectory` on
 * #folder-input gives a flat FileList of every file inside the chosen folder
 * (recursive), each a normal File - this loops `uploadFile` once per accepted one,
 * sequentially (not in parallel, to avoid saturating ingestion-service's own
 * Bucket4j rate limit with N simultaneous requests, and matching the roadmap's own
 * "loops the same call once per file" description). A file whose extension isn't in
 * `ACCEPTED_EXTENSIONS` is skipped without ever calling the backend; a file the
 * backend itself rejects (415/422) is skipped too, with the server's own message as
 * the reason - both render as a skipped row via addSkippedHistoryEntry, in the same
 * list a successful import renders in, so the whole batch reads as one mixed feed.
 */
folderInput.addEventListener("change", async () => {
  ...
  for (let i = 0; i < files.length; i++) {
    const file = files[i];
    setStatus(uploadStatus, t("documents.folderImporting", { current: i + 1, total: files.length, imported, skipped }));

    if (!isAcceptedExtension(file.name)) {
      addSkippedHistoryEntry(file.name, t("documents.folderSkippedUnsupported"));
      skipped++;
      continue;
    }
    ...
    try {
      const body = await uploadFile(file);
      if (!body) {
        // Session expired mid-batch (uploadFile already ran clearAuth) - the
        // remaining files can't be imported either, no point looping further.
        return;
      }
      addHistoryEntry(body);
      imported++;
    } catch (error) {
      addSkippedHistoryEntry(file.name, error.message ?? t("documents.uploadFailed"));
      skipped++;
    }
  }

  setStatus(uploadStatus, t("documents.folderImportDone", { imported, skipped }), "success");
});

function addHistoryEntry({ documentId, source, chunkCount, pageCount }) {
  uploadHistoryHeader.hidden = false;
  const item = document.createElement("li");
  item.innerHTML = `
    <span class="source">${docIconSvg()}${escapeHtml(source)}</span>
    <span class="meta-col">${t("documents.pagesValue", { pages: pageCount })}</span>
    <span class="meta-col">${t("documents.chunksValue", { chunks: chunkCount })}</span>
    <div class="insight-actions">
      <button type="button" class="summarize-button">${t("documents.summarizeButton")}</button>
      <button type="button" class="generate-faq-button">${t("documents.generateFaqButton")}</button>
      <label class="compare-checkbox-label">
        <input type="checkbox" class="compare-checkbox" value="${escapeHtml(documentId)}" />
        ${t("documents.compareCheckboxLabel")}
      </label>
      ${rowMenuHtml()}
    </div>
  ...
  wireRowMenu(item, documentId, item.querySelector(".insight-status"));
  uploadHistory.prepend(item);
}

/**
 * docs/EXTERNAL-DATA-INTEGRATION-ROADMAP.md Phase 2: renders a file the folder
 * import skipped (unsupported extension or a server-side rejection) - same list,
 * same icon, but no documentId to act on, so no insight/compare/kebab actions, just
 * the reason in place of them.
 */
function addSkippedHistoryEntry(name, reason) {
  uploadHistoryHeader.hidden = false;
  const item = document.createElement("li");
  item.className = "history-skipped";
  item.innerHTML = `
    <span class="source">${docIconSvg()}${escapeHtml(name)}</span>
    <span class="meta skipped-reason">${escapeHtml(reason)}</span>
  `;
  uploadHistory.prepend(item);
}
...
function renderInsightComparison({ comparison, sources }) {
  insightTitle.textContent = t("documents.comparisonTitle");
  insightSource.textContent = sources.join(", ");
  insightComparison.textContent = comparison;
  insightComparison.hidden = false;
  insightSummary.hidden = true;
  insightFaqList.hidden = true;
  insightCard.hidden = false;
  insightCard.scrollIntoView({ behavior: "smooth", block: "start" });
...
/**
 * docs/adr/0057-document-comparison.md. Shared between the two "Compare selected"
 * buttons (session history and admin document list) - each reads only its own
 * list's checked `.compare-checkbox` inputs, same "each list has its own action"
 * shape as everything else in this view.
 */
async function compareSelectedDocuments(listContainer, statusEl) {
  const documentIds = Array.from(listContainer.querySelectorAll(".compare-checkbox:checked"))
    .map((input) => input.value);
  if (documentIds.length < 2) {
    setStatus(statusEl, t("documents.selectAtLeastTwo"), "error");
    return;
  }

  setStatus(statusEl, t("documents.comparing"));
  try {
    const response = await fetch(`${RAG_BASE}/api/v1/documents/compare`, {
      method: "POST",
      headers: { "Content-Type": "application/json", ...authHeader() },
    ...
    const body = await response.json();
    if (!response.ok) {
      throw new Error(body.message ?? t("documents.compareFailed"));
    }
    renderInsightComparison(body);
    setStatus(statusEl, "", "");
  } catch (error) {
    setStatus(statusEl, error.message ?? t("documents.compareFailed"), "error");
  }
}

compareHistoryButton.addEventListener("click", () => compareSelectedDocuments(uploadHistory, compareHistoryStatus));
compareAdminButton.addEventListener("click", () => compareSelectedDocuments(adminDocumentsList, compareAdminStatus));
...
startConversationButton.addEventListener("click", async () => {
  ...
  try {
    ...
    conversationEmptyHint.hidden = true;
